...
public class EjemplarConTituloDTO {
    ...
    /**
     * ID de la publicación asociada al ejemplar.
     * 
    ...
    /**
     * Número de edición de la publicación.
     * 
     * @return Número de edición de la publicación
     */
    private final int numEdicion;
    /**
     * Tipo de publicación (enum TipoPublicacion).
     * 
     ...
     */
    public EjemplarConTituloDTO(final int idEjemplar, final int idPublicacion, final int numEjemplar,
            final String estado, final String titulo,
            final int numEdicion, final TipoPublicacion tipoPublicacion) {
