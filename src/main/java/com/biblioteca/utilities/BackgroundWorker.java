 ...
 * Uso:
 * BackgroundWorker.run(() -> heavyWork(), result -> updateUI(result), ex ->
 * handle(ex));
 */
public final class BackgroundWorker {
    ...
    /**
     * Ejecuta una tarea en background y maneja el resultado o error en el hilo de
     * la UI.
     * 
     ...
     */
    public static <T> SwingWorker<T, Void> run(final Supplier<T> task, final Consumer<T> onDone,
