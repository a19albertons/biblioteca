...
public class ControladorSancionManual {
     ...
     * @param dbConnection
     */
    public ControladorSancionManual(com.example.conexiones.DBConnection dbConnection) {
    ...
    public String[] obtenerUltimoPrestamoPorEjemplar(int idEjemplar) {
        com.example.dao.PrestamoDAO prestamoDAO = new com.example.dao.PrestamoDAO(this.dbConnection);
    ...
    public String[] obtenerSancionActivaPorUsuario(int idUsuario) {
        com.example.dao.SancionDAO sancionDAO = new com.example.dao.SancionDAO(this.dbConnection);
